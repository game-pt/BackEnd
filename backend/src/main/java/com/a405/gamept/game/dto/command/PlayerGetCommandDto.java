...
public record PlayerGetCommandDto(
        ...
        public static PlayerGetCommandDto from(PlayerGetRequestDto playerGetRequestDto) {
                return PlayerGetCommandDto.builder()
                        .gameCode(playerGetRequestDto.gameCode())
                        .playerCode(playerGetRequestDto.playerCode())
                        .build();
        }
}
